...
class Polymod
{
	...
	public static function registerAllScriptClasses():Void
	{
		...
		@:privateAccess {
			...
			{	
				if (textPath.endsWith(DefineUtil.getDefineString('POLYMOD_SCRIPT_CLASS_EXT', '.hxc'))
					|| textPath.endsWith(DefineUtil.getDefineString('POLYMOD_SCRIPT_CLASS_EXT', '.hx'))
					|| textPath.endsWith(DefineUtil.getDefineString('POLYMOD_SCRIPT_CLASS_EXT', '.hscript'))
					|| textPath.endsWith(DefineUtil.getDefineString('POLYMOD_SCRIPT_CLASS_EXT', '.hxs')))  {
